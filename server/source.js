...
// // Handle the 'ready' event, which fires when the connection is established


// // Handle the 'error' event
// imap.once('err', handleError);

// // Handle the 'close' event, which fires when the connection is closed
// imap.once('close', () => {
//   console.log('Connection to Gmail IMAP server closed.');
// });
